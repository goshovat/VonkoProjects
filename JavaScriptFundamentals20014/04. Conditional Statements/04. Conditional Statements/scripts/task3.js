        ...
        if (isNaN(input0) || isNaN(input1) || isNaN(input2)) {
            ...
            if (input0 >= input1 && input0 >= input2) {
                if (input0 === input1 && input0 === input2) {
                    ...
                    if (input0 > input1 && input0 === input2) {
                        output = 'The biggest numbers are ' + input0 + ' and ' + input2;
                    }
                    else if (input0 > input2 && input0 === input1) {
                        output = 'The biggest numbers are ' + input0 + ' and ' + input1;
                    }
                    else if ((input0 > input1 && input1 === input2) ||
                        (input0 > input1 && input0 > input2)) {
                        output = 'The biggest number is ' + input0;
                    }
                }
            }
            else if (input0 >= input1 && input0 <= input2) {
                if (input0 >= input1 && input0 < input2) {
                    output = 'The biggest number is ' + input2;
                }
            }
            else if (input0 >= input2 && input0 <= input1) {
                if (input0 >= input2 && input0 < input1) {
                    output = 'The biggest number is ' + input1
                }
            }
            else if (input0 <= input1 && input0 <= input2) {
                if (input0 < input1 && input0 < input2) {
                    if (input1 === input2) {
                        output = 'The biggest numbers are ' + input1 + ' and ' + input2;
                    }
