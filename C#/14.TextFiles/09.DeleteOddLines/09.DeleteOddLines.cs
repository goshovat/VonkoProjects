...
class DeleteOddLines
{
    ...
    {
        StreamReader reader = new StreamReader(filePathName, Encoding.GetEncoding(1251));

        string tempFileName = @"..\..\TempFile.txt";
        StreamWriter tempFile = new StreamWriter(tempFileName, false, Encoding.GetEncoding(1251));
