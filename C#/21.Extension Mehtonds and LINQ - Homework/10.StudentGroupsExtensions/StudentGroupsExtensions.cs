    ...
    class StudentGroupsExtensions
    {
        static void Main()
        {
            List<Student> students = new List<Student>() 
            {
                ...
                new Student("Mitko", "Genchev", 42413, "+3598815124", "pencho@abv.bg", 2),
                new Student("Stamen", "Penchev", 42414, "+35981244", "pencho@gmail.com", 1),
                new Student("Tsvetko", "Ivanov", 42415, "+3598815124", "pencho@abv.bg", 4),
                ...
                new Student("Vonko", "Penchev", 42419, "+3598815124", "pencho@abv.bg", 2),
                new Student("Conko", "Todorov", 424110, "+3598815124", "pencho@gmail.com", 2),
                new Student("Ronko", "Penchev", 424111, "+3598815124", "pencho@abv.bg", 3),
            };
