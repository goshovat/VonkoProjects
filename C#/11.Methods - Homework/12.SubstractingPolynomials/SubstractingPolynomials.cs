...
class SubstractingPolynomials
{
    static void Main()
    {
        //In this task I used more efficent method to handle polynomials I learned from a collegue
    ...
    static void SubstractionOfPolinomials(decimal[] firstPolinomial, 
        decimal[] secondPolinomial, decimal[] result)
    {
        int minLenght = 0;
