namespace BinarySearchTree
{
        ...
        where T : IComparable<T>
    {
        ...
        private bool CheckRecursiveEquality(TreeNode<T> treeNode1, TreeNode<T> treeNode2, bool areEqual)
        {
            if (areEqual == true)
            {
                //first check if some of the elements is null
                if (treeNode1 == null && treeNode2 != null || treeNode2 != null && treeNode2 == null ||
                    treeNode1 == null && treeNode2 != null || treeNode2 != null && treeNode2 == null)
                {
                    areEqual = false;
                }
