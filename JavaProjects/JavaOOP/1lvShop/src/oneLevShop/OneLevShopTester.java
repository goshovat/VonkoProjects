...
public class OneLevShopTester {
	...
	public static void main(String[] args) {
		try {
			Calendar ciggarsExpiry = getCalendar(2014, 12, 31);
			...
			Calendar salamExpiry = getCalendar(2014, 12, 27);
			...
			Calendar whiskyExpiry = getCalendar(3214, 12, 29);
			Product whisky = new FoodProduct("Bushmill", 30, 300, 
					AgeRestriction.Adult, whiskyExpiry);
